...
const About = () => {
  return (
    <div>
        <div class="text-2xl font-bold mb-5">About Us</div>
        <div>Introducing "MixMaster," the ultimate party sidekick app that fetches
        ...
        time, and let the laughter and giggles flow!</div>
    </div>
  )
}
